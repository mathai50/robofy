...
const ContactDetails = () => {
  ...
  const socialLinks = [
    {
      name: 'LinkedIn',
      url: 'https://linkedin.com/company/robofy',
      icon: (
        ...
        <div className="flex justify-center space-x-4">
          {socialLinks.map((social, index) => (
            <a
              ...
              className="w-10 h-10 bg-white/10 rounded-full flex items-center justify-center text-gray-300 hover:text-white hover:bg-blue-600 transition-all duration-300 transform hover:scale-110"
